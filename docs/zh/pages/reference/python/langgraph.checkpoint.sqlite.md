...
<!-- langgraph-docs: langgraph.checkpoint.sqlite | https://reference.langchain.com/python/langgraph.checkpoint.sqlite.md -->
...
- [⟦T0⟧](https://reference.langchain.com/python/langgraph.checkpoint.sqlite/SqliteSaver)
- [⟦T1⟧](https://reference.langchain.com/python/langgraph.checkpoint.sqlite/aio/AsyncSqliteSaver)
