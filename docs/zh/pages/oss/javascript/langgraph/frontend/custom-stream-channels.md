...
自定义通道有两端。在服务器上，[⟦T20⟧](https://reference.langchain.com/javascript/langchain-langgraph/index/StreamTransformer)打开一个
命名为 [⟦T21⟧](https://reference.langchain.com/javascript/langchain-langgraph/index/StreamChannel) 并向其推送有效负载。在客户端，有一个选择器
...
命名空间见[Graph execution](/oss/javascript/langgraph/frontend/graph-execution)
瞄准。
...
* [Overview](/oss/javascript/langgraph/frontend/overview) — LangGraph 前端流
  API 和架构。
* [Graph execution](/oss/javascript/langgraph/frontend/graph-execution) — 命名空间范围
  多节点管道的选择器。
